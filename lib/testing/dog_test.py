...
class TestDog:
    ...
    def test_is_class(self):
        ...
        fido = Dog(name="Fido", breed="Corgi")  # Provide both name and breed
    ...
    def test_name_not_empty(self):
        ...
        Dog(name="", breed="Corgi")  # Provide a breed
    ...
    def test_name_string(self):
        ...
        captured_out = io.StringIO()
        sys.stdout = captured_out
        Dog(name=123, breed="Corgi")  # Provide a breed
        sys.stdout = sys.__stdout__
        assert captured_out.getvalue() == "Name must be a string between 1 and 25 characters.\n"
    ...
    def test_name_under_25(self):
        ...
        captured_out = io.StringIO()
        sys.stdout = captured_out
        Dog(name="What do dogs do on their day off? Can't lie around - that's their job.", breed="Corgi")
        sys.stdout = sys.__stdout__
        assert captured_out.getvalue() == "Name must be a string between 1 and 25 characters.\n"

    def test_valid_name(self):
        '''saves name if string between 1 and 25 characters.'''
        fido = Dog(name="Fido", breed="Corgi")  # Provide a breed
    ...
    def test_breed_not_in_list(self):
        ...
        captured_out = io.StringIO()
        sys.stdout = captured_out
        Dog(name="Fido", breed="Human")  # Provide a name
        sys.stdout = sys.__stdout__
    ...
    def test_breed_in_list(self):
        ...
        fido = Dog(name="Fido", breed="Pug")  # Provide a name
